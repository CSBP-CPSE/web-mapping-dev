(function () {
    ...
    var config$6 = {
      ...
      legend: [{
        ...
        color: [255, 255, 204],
        label: {
          en: "Between 0.000 and 0.01",
          fr: "Entre 0.000 et 0.01"
        }
      }, {
        color: [220, 251, 230],
        label: {
          en: "Between 0.01 and 0.02",
          fr: "Entre 0.01 et 0.02"
        }
      }, {
        color: [161, 218, 180],
        label: {
          en: "Between 0.02 and 0.03",
          fr: "Entre 0.02 et 0.03"
        }
      }, {
        color: [65, 182, 196],
        label: {
          en: "Between 0.03 and 0.04",
          fr: "Entre 0.03 et 0.04"
        }
      }, {
        color: [44, 127, 184],
        label: {
          en: "Between 0.04 and 0.05",
          fr: "Entre 0.04 et 0.05"
        }
      }, {
        color: [37, 52, 148],
        label: {
      ...
      selected: "db",
      classes: ['case', ['==', ['get', 'lib_prox'], null], '#color1', ['==', ['get', 'lib_prox'], 0], '#color2', ['<', ['get', 'lib_prox'], 0.01], '#color3', ['<', ['get', 'lib_prox'], 0.02], '#color4', ['<', ['get', 'lib_prox'], 0.03], '#color5', ['<', ['get', 'lib_prox'], 0.04], '#color6', ['<', ['get', 'lib_prox'], 0.05], '#color7', '#color8'],
      fields: [{
        id: "lib_prox",
        label: {
