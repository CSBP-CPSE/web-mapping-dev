(function () {
    ...
    var config$3 = {
      ...
      legend: [{
        ...
        color: [255, 255, 178],
        label: {
          en: "Between 0.00 et 0.02",
          fr: "Entre 0.00 et 0.02"
        }
      }, {
        color: [254, 204, 92],
        label: {
          en: "Between 0.02 et 0.05",
          fr: "Entre 0.02 et 0.05"
        }
      }, {
        color: [253, 141, 60],
        label: {
          en: "Between 0.05 et 0.12",
          fr: "Entre 0.05 et 0.12"
        }
      }, {
        color: [240, 59, 32],
        label: {
          en: "Between 0.12 et 0.20",
          fr: "Entre 0.12 et 0.20"
        }
      }, {
        color: [189, 0, 38],
        label: {
          en: "Between 0.20 et 0.40",
    ...
    var config$4 = {
      ...
      legend: [{
        ...
        color: [220, 251, 230],
        label: {
          en: "Between 0.000 et 0.085",
          fr: "Entre 0.000 et 0.085"
        }
      }, {
        color: [161, 218, 180],
        label: {
          en: "Between 0.085 et 0.310",
          fr: "Entre 0.085 et 0.31"
        }
      }, {
        color: [255, 255, 204],
        label: {
          en: "Between 0.310 et 0.800",
          fr: "Entre 0.310 et 0.800"
        }
      }, {
        color: [65, 182, 196],
        label: {
          en: "Between 0.800 et 1.000",
          fr: "Entre 0.800 et 1.000"
        }
      }, {
        color: [44, 127, 184],
        label: {
          en: "Between 1.000 et 2.000",
      ...
      selected: "db",
      classes: ['case', ['==', ['get', 'trips_prx'], null], '#color1', ['<', ['get', 'trips_prx'], 0.085], '#color2', ['<', ['get', 'trips_prx'], 0.31], '#color3', ['<', ['get', 'trips_prx'], 0.8], '#color4', ['<', ['get', 'trips_prx'], 1], '#color5', ['<', ['get', 'trips_prx'], 2], '#color6', '#color7'],
      fields: [{
        id: "trips_prx",
        label: {
