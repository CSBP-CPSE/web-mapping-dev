(function () {
	...
	var nls = {
	  ...
	  "Label_CCS": {
	    ...
	    "fr": "Sous-division de recensement unifiée (SRU)"
	  },
	  "Label_DA": {
	...
	function (_Popup) {
	  ...
	  _createClass(Splash, [{
	    ...
	    key: "Template",
	    value: function Template() {
	      return "<div handle='root' class='popup modal'>" + "<div class='popup-container'>" + "<button class='close' handle='close'>×</button>" + "<div class='popup-body' handle='body'>" + "<h1>nls(Splash_LODE_Title)</h1>" + "<hr>" + "<p class='warning'>nls(Splash_Warning)</p>" + "<hr>" + "<p>nls(Splash_LODE_1)</p>" + "<div class='logo-container'>" + "<img class='logo' src='lode-logo.png' />" + "</div>" + "<p>nls(Splash_LODE_2)</p>" + "<p>nls(Splash_LODE_3)</p>" + "<hr>" + "<div class='wip-container'>" + "<div><img src='warning.png' /></div>" + "<div>nls(Splash_WIP)</div>" + "</div>" + "<div class='continue-container'>" + "<button class='continue' handle='continue'>nls(Splash_Continue)</button>" + "</div>" + "</div>" + "</div>" + "</div>";
	    }
	  }]);
	...
	function (_Control) {
	  ...
	  function Legend(options) {
	    ...
	    _this.radios.ccs.addEventListener('change', _this.onChange_Handler.bind(_assertThisInitialized(_this), 'ccs'));
