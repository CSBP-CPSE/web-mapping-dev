(function () {
    ...
    var config = {
      style: "mapbox://styles/staubbr/ck0r79owi29461cnv5hga13gh",
    ...
    var config$3 = {
      style: "mapbox://styles/staubbr/ck2v8a6oo0i4e1clagcjjbqk7",
      layers: ["db"],
      title: {
    ...
    var config$4 = {
      ...
      layers: ["db"],
      title: {
        "en": "Proximity to public transit trips<br>(preliminary experimental results)",
        "fr": "Proximité aux voyages de transport en commun<br>(résultats expérimentaux préliminaires)"
      },
      legend: [{
        color: [200, 200, 200],
        label: {
    ...
    var config$5 = {
      ...
      layers: ["db"],
      title: {
        "en": "Proximity to education facilities<br>(preliminary experimental results)",
        "fr": "Proximité aux établissements d'éducation<br>(résultats expérimentaux préliminaires)"
      },
      legend: [{
        color: [200, 200, 200],
        label: {
      ...
      selected: "db",
      classes: ['case', ['==', ['get', 'educ_prx'], null], '#color1', ['==', ['get', 'educ_prx'], 0], '#color2', ['<', ['get', 'educ_prx'], 0.005], '#color3', ['<', ['get', 'educ_prx'], 0.010], '#color4', ['<', ['get', 'educ_prx'], 0.020], '#color5', ['<', ['get', 'educ_prx'], 0.040], '#color6', ['<', ['get', 'educ_prx'], 0.070], '#color7', '#color8'],
      fields: [{
        id: "educ_prx",
        label: {
    ...
    var config$6 = {
      ...
      layers: ["db"],
      title: {
        "en": "Proximity to libraries<br>(preliminary experimental results)",
        "fr": "Proximité aux bibliothèques<br>(résultats expérimentaux préliminaires)"
      },
      legend: [{
        color: [200, 200, 200],
        label: {
      ...
      selected: "db",
      classes: ['case', ['==', ['get', 'lib_prox'], null], '#color1', ['==', ['get', 'lib_prox'], 0], '#color2', ['<', ['get', 'lib_prox'], 0.002], '#color3', ['<', ['get', 'lib_prox'], 0.005], '#color4', ['<', ['get', 'lib_prox'], 0.010], '#color5', ['<', ['get', 'lib_prox'], 0.030], '#color6', ['<', ['get', 'lib_prox'], 0.050], '#color7', '#color8'],
      fields: [{
        id: "lib_prox",
        label: {
      ...
      function Legend(options) {
        ...
        if (_this.options.toc) {
          ...
          if (_this.options.selected) {
            _this.current = _this.options.selected;
    ...
    if (cfg == "education") Config = config$5;
    if (cfg == "library") Config = config$6;
    ...
    function Initialize() {
      ...
      var map = Factory.Map('map', style, [-75.6972, 45.4215], 11);
      ...
      function HTMLize(json, fields) {
        ...
        fields.forEach(function (f) {
          ...
          var value = Core.Nls("Map_Not_Available");

          if (json.hasOwnProperty(f.id) || f.polish) {
            value = f.polish ? polish(json, f.polish, 2) : json[f.id];
