(function () {
	...
	function (_Control) {
	  ...
	  function Legend(options) {
	    ...
	    _this.options.layers.forEach(function (l) {
	      this.radios[l] = this.Node('rd' + l.toUpperCase());
	      this.radios[l].addEventListener('change', this.onChange_Handler.bind(this, l));
	    }.bind(_assertThisInitialized(_this)));
	  ...
	  _createClass(Legend, [{
	    ...
	    value: function Template() {
	      ...
	      this.options.layers.forEach(function (l) {
	        radioHTML += "<label><input handle='rd" + l.toUpperCase() + "' type='radio' name='boundary'>nls(Label_" + l.toUpperCase() + ")</label>";
	      });
	...
	function () {
	  ...
	  _createClass(Factory, null, [{
	    ...
	    key: "LegendControl",
	    value: function LegendControl(layers, selected) {
	      return new Legend({
	        layers: layers,
	        selected: selected
	      });
	...
	function Initialize() {
	  ...
	  var legend = Factory.LegendControl(config.layers, config.selected);
	  ...
	  map.on('load', function (ev) {
	    legend.Select(config.selected); // Maybe make a classification function in MBT.Map
