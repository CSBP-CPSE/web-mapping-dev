(function () {
    ...
    var config = {
      ...
      selected: "da",
      classes: ['case', ['all', ['==', ['get', 'population'], 0], ['==', ['get', 'buildings'], 0]], '#color1', ['==', ['get', 'population'], 0], '#color2', ['==', ['get', 'buildings'], 0], '#color3', ['<', ['/', ['get', 'population'], ['get', 'buildings']], 1.5], '#color4', ['<', ['/', ['get', 'population'], ['get', 'buildings']], 2.5], '#color5', ['<', ['/', ['get', 'population'], ['get', 'buildings']], 5], '#color6', ['<', ['/', ['get', 'population'], ['get', 'buildings']], 20], '#color7', '#color8'],
      fields: [{
        id: "uid",
        label: {
          en: "ID",
    ...
    var config$2 = {
      ...
      legend: [{
        ...
        color: [255, 255, 204],
        label: {
          en: "Between 20 et 100",
          fr: "Entre 20 et 100"
        }
      }, {
        color: [65, 182, 196],
        label: {
          en: "Between 100 et 500",
          fr: "Entre 100 et 500"
        }
      }, {
        color: [44, 127, 184],
        label: {
          en: "Between 500 et 5000",
          fr: "Entre 500 et 5000"
        }
      }, {
        color: [37, 52, 148],
        label: {
    ...
    function (_Control) {
      ...
      function Legend(options) {
        ...
        _this.radios = {};
        if (_this.options.toc) _this.AssignRadioButtons(_this.options.toc);
      ...
      _createClass(Legend, [{
        ...
        value: function LegendTemplate(legend) {
          ...
          return "<div class='legend-label'>nls(Toc_Legend)</div>" + "<div class='legend-container'>" + html + "</div>";
        }
      }, {
        key: "TocTemplate",
    ...
    function () {
      ...
      _createClass(Factory, null, [{
        ...
        key: "LegendControl",
        value: function LegendControl(toc, selected, legend) {
          return new Legend({
            toc: toc,
            selected: selected,
            legend: legend
    ...
    function Initialize() {
      ...
      var legend = Factory.LegendControl(Config.toc, Config.selected, Config.legend);
      ...
      map.on('load', function (ev) {
        if (Config.selected) legend.Select(Config.selected); // Maybe make a classification function in MBT.Map
